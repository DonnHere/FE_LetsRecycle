...
const RecyclePage = () => {
  return (
    <div className="font-sans">
      ...
      <section className="bg-white-100 text-center py-12 px-4">
        ...
        <img src="assets/24x24.png" alt="Hero" className="mx-auto w-full max-w-lg mb-6" />
      </section>
  ...
  <div className="container mx-auto flex justify-center items-center min-h-screen">
    <div className="w-full md:w-1/2 bg-gray-100 p-6 rounded-lg shadow-md max-w-xl">
      <img src="assets/sumbersampah.png" alt="Problem" className="mx-auto w-full mb-6" />
      ...
      <section className="py-12 bg-green-50 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-white shadow-lg rounded-lg">
            <img src="assets/reduce.png" alt="Reduce" className="w-16y h-16 mx-auto" />
          ...
          <div className="text-center p-4 bg-white shadow-lg rounded-lg">
            <img src="assets/reuse.png" alt="reuse.png" className="w-16 h-16 mx-auto" />
          ...
          <div className="text-center p-4 bg-white shadow-lg rounded-lg">
            <img src="assets/recycle.png" alt="Recycle" className="w-16 h-16 mx-auto" />
